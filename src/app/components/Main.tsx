...
<main class="flex-1 px-5">
  <div class="flex flex-col items-center">
    <div class="border border-blue-900 w-32 h-32">
      <p>Aquí irá una imagen grande</p>
    </div>
    <p class="text-center w-10/12">
      Sit minim esse pariatur elit excepteur occaecat mollit nisi exercitation
      minim. Aquí irán unas palabras gei.
    </p>
  </div>
